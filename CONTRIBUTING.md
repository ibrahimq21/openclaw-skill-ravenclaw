...
2. Clone your fork locally:
   ```bash
   git clone https://github.com/ibrahimq21/openclaw-skill-ravenclaw.git
   cd openclaw-skill-ravenclaw
   ```
...
```bash
git remote add upstream https://github.com/ibrahimq21/openclaw-skill-ravenclaw.git
```
